...
| OTP_VERSION       | This parameter defines the OTP version being used on the backend.                                                                                                                                   | 1                                 |
...
| OTP_VERSION                                                          | integer | Optional | 1                                              | Config setting for the backend OTP Version.                                                                                                                                    |
